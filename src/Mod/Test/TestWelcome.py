...
"""
This module contains FreeCAD commands for the Test workbench.
Upon opening the Test workbench for the first time, a dialog box will appear
to inform the user about the functionality of the Test workbench.
"""
...
class Test_Welcome:
    ...
    def GetResources(self):
        ...
        return {'MenuText': QT_TRANSLATE_NOOP("Test_Welcome", "Test WB Welcome screen"),
                'ToolTip' : QT_TRANSLATE_NOOP("Test_Welcome", "Show the Test workbench welcome screen")}
    ...
    def Activated(self):
        ...
        FreeCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Test").SetBool("FirstTime",False)
